...
\input{parts/oseen}
\input{parts/cwt}
\input{parts/experimental}
\input{parts/martins_papers}
...
\input{parts/simple_cavity}
\input{parts/defect_cavity}
\input{parts/hybrid_cavity}
\input{parts/hybrid_defect_cavity}
\chapter{Conclusion}
\input{parts/conclusion}
\printbibliography
\appendix
\input{parts/code_appendix}
\input{parts/reflectivities_appendix}
\input{parts/transmittivities_appendix}
\input{parts/laser_cavities_appendix}
\end{document}
